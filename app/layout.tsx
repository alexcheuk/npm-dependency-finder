...
export const metadata: Metadata = {
  ...
  description: 'Find the minimal parent npm package version that satisfies child package requirements. Resolve vulnerabilities with minimal changelog impact. Free developer tool for npm dependency management.',
  keywords: ['npm', 'package manager', 'dependency', 'vulnerability', 'security', 'version finder', 'node.js', 'javascript', 'developer tools'],
  authors: [{ name: 'npm Version Finder', url: 'https://npm-version-finder.dev' }],
  ...
  twitter: {
    ...
    title: 'npm Version Finder - Resolve Package Vulnerabilities',
    description: 'Find the minimal parent npm package version that satisfies child package requirements. Free developer tool.',
    images: ['/og-image.png'],
